...
================================================== -->
  ...
  $totalSql = "SELECT COUNT(id) AS total FROM report";
  $totalResult = mysqli_query($conn, $totalSql);
  $totalRow = mysqli_fetch_assoc($totalResult);
  $total = $totalRow['total'];
  $lastPageNumber = ceil($total/$number_of_posts);

  $sql = "SELECT * FROM report LIMIT " . $start . ", " . $number_of_posts;
  $result = mysqli_query($conn, $sql);
  if (mysqli_num_rows($result) > 0) {
        ...
        while($row = mysqli_fetch_assoc($result)) {
          ...
          <tr>
            <td><?php echo $row['firstname'] . ' ' . $row['lastname']  ?></td>
              ...
              <td><?php echo $row['areaaffected'];  ?></td>
              <td><?php echo $row['affectedstate'];  ?></td>
              <td><?php echo $row['affecteddistrict'];  ?></td>
              <td><?php echo $row['affectedtown'];  ?></td>
              <td><?php echo $row['affectedpin'];  ?></td>
            ...
            <td>
              ...
              <a href="edit_status.php?id=<?php echo $row['id'] ?>">Edit</a>
              <a href="delete_report.php?id=<?php echo $row['id'] ?>" onclick="return confirmDelete()">Delete</a>
            </td>
          </tr>
          <?php
        }
    ...
    <ul class="pagination" >
      ...
      if ($page != 1) { 
        ?>
        <li class="page-item"><a href="registered_reports.php?page=<?php echo $page - 1 ?>" class="page-link">Prev</a></li>
        <?php
      }
      ...
      if ($page != $lastPageNumber) {
        ?>
        <li class="page-item"><a href="registered_reports.php?page=<?php echo $page + 1 ?>" class="page-link">Next</a></li>
        <?php
      }
      ?>
    </ul>
