...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  if (mysqli_num_rows($result) > 0) {
	...
	header('Location:editpro_login.php');
}
...

_WebResourceData_WebResourceMIMEType_WebResourceTextEncodingName^WebResourceURL_WebResourceFrameNameO(Ë<!DOCTYPE html><html lang="en" class=" js cssanimations"><head>
  <meta charset="utf-8">
                ...
                <ul style="width: 100%; height: 100%; position: relative;">
                  <li class="current-frame" style="display: list-item; width: 100%; height: 100%; position: absolute; z-index: 1;">
                    <div class="info animate-in" style="display: block;">
                      ...
                      <a class="btn btn-success" href="#">Learn more Â»</a>
                    </div>
            ...
            <div class="centered">
              ...
              <p>
                Report crop loss details and claim the insurance.
                  ...
                  <button class="btn btn-color btn-rounded" type="submit">Report</button>
...
</body></html>Ytext/htmlUUTF-8_,file:///Users/siddharthnath/PMFBY/index.htmlP¯ #'+/37;?DHMQUY^cgkosw{ƒ‡‹“Õ_WebResourceResponseO%ê/* cyrillic-ext */
@font-face {
...
Xtext/cssUutf-8OŸbplist00ÔjkX$versionX$objectsY$archiverT$top