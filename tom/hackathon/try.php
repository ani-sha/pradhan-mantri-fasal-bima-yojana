...
<body>
  ...
  <section id="maincontent">
    <div class="container" style="margin: 200px 450px" >
      <div class="row">
        ...
        <div class="span4"  >
          <div class="well ">
            <div class="centered">
              <button onclick="document.getElementById('id01').style.display='block'" style="width:auto " >Login to Continue</button>
                </div>
              </p>
            </div>
          </div>
 ...
 ================================================== -->
  ...
  <script type="assets/js/button.js"></script>
