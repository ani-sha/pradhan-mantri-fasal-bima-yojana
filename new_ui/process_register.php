...
if (isset($_POST['insuredevidence'])) {
    $insuredevidence = $_POST['insuredevidence'];
}
...
$sql = "INSERT INTO farm (sid,firstname, lastname,password,confirmpassword, dob, gender, caste, aadharno, mobileno, username,addressline1, addressline2,state,city,district,pin,farmertype,farmercategory,bankname,branchname,ifsc,savings,farmerid,insuredevidence,insurancecompany) VALUES ('" . $sid . "','" . $firstname . "', '" . $lastname . "','" . $password . "','" . $confirmpassword . "', '" . $dob . "', '" . $gender . "', '" . $caste . "', '" . $aadharno . "','" . $mobileno . "', '" . $username . "','" . $addressline1 . "', '" . $addressline2 . "','" . $state . "','" . $city . "','" . $district . "','" . $pin . "','" . $farmertype . "','" . $farmercategory . "','" . $bankname . "','" . $branchname . "','" . $ifsc . "','" . $savings . "','" . $farmerid . "','" . $insuredevidence . "','" . $insurancecompany . "',);";
