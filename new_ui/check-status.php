            ...
            <div class="col-xl-9 col-lg-10 mx-auto">
              <div class="bg-faded rounded p-5">
                <h2 class="section-heading mb-4">
                  ...
                  <span class="section-heading-lower-2">Choose your option</span>
                </h2>
                <div class="login-page-1">
                  <div class="form-1">
                    
                      <form class="login-form-1" method="" action="application_status_login.php">
                        <button> Application Status</button>
                        </form>
                        <br><br><h4 class="section-heading-lower-3">OR</h4><br>
                        <form class="login-form-1" method="" action="physicalverification_login.php">
                        <button>Physical Verification Status</button>
