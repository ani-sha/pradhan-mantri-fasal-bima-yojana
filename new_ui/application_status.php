...
<body>
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    <?php echo 'Physical Verification Date : '. $user['physicalverificationdate'];?><br><br>

    <?php echo 'Verifier Name : '. $user['verifiername'];?><br><br>
    <?php echo 'Verifier Govt. ID: '. $user['verifierid'];?><br><br>
