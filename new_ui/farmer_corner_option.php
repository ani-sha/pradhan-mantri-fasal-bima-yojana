            ...
            <div class="col-xl-9 col-lg-10 mx-auto">
              <div class="bg-faded rounded p-5">
                ...
                <div class="login-page-1">
                  <div class="form-1">
                    <form class="login-form-1" method="post" action="register.php">
                      <button  >Register as Farmer</button>
                      </form>
                      <br><h4 class="section-heading-lower-3">OR</h4><br>
                      <form class="login-form-1" method="" action="register-login.php">
