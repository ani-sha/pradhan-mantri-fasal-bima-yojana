...
$sql = "SELECT id,isFarmer FROM farm WHERE username = '" . $_POST['USERNAME'] . "' AND password = '" . $_POST['PASSWORD'] . "' LIMIT 1";
...
if (mysqli_num_rows($result) > 0) {
 ...
 header('Location:physicalverification_status.php?id='.$row['id'] );
}else{
            ...
            <div class="col-xl-9 col-lg-10 mx-auto">
              <div class="bg-faded rounded p-5">
                <h2 class="section-heading mb-4">
                  ...
                  <span class="section-heading-lower-1">Log In</span>
                </h2>
                <div class="login-page-1">
                  <div class="form-1">
                    <form class="login-form-1" method="post">
