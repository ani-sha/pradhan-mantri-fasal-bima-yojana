  ...
  <header>
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          <!-- logo -->
          <a class="brand logo" href="index.html"><img src="assets/img/new.png" alt=""></a>
          <!-- end logo -->
          <!-- top menu -->
          <div class="navigation">
            <nav>
              <ul class="nav topnav">
                <li class="dropdown">
                  <a href="dup_farmer_index.php">Home</a>
                </li>
...
<form action="uniqueid.php" method="post" id = "registrationForm" role="form" class="contactForm" style="margin-left: 300px" >
  ...
  <div class="span8 form-group">
            <input type="number" name="farmerid" class="form-control"  style="height: 40px" id="" placeholder="Farmer ID Proof Number" value="<?php echo $farmerid?>" />


</div>
<div class="span4 form-group ">
      <h3 style= "color: #94c045" >INSURED FARMER PROOF</h3>
      <input type="file" name="insuredevidence" class="form-control" id="fileupload" placeholder="Upload"  />

  </div>


    <div class="span4 form-group">
                 <select class="form-dropdown " id="input_14" name="insurancecompany" style="width:356px" data-component="dropdown" required="">
                  <option name="" value="">Insurance Company Name </option>
                  <option name="" value="AGRICULTURE INSURANCE COMPANY  "> AGRICULTURE INSURANCE COMPANY </option>
                  <option name="" value="BAJAJ ALLIANZ GENERAL INSURANCE CO. LTD"> BAJAJ ALLIANZ GENERAL INSURANCE CO. LTD </option>

                  <option name="" value="BHARTI AXA GENERAL INSURANCE COMPANY LTD."> BHARTI AXA GENERAL INSURANCE COMPANY LTD. </option>
